...
namespace HastaneKayitSistemi
{
    public partial class FormDoktorPaneli : Form
    {
        ...
        {
            // Cinsiyet kutusunu doldur (Tasarımda boşsa buradan dolar)
        ...
        // ------------------------------------------------------------------------
        // 3. TABLOYU VE COMBOBOX'I GÜNCELLE
        // ------------------------------------------------------------------------
        ...
        private void BtnEkle_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                command.Parameters.AddWithValue("@p4", SecurityHelper.Hashle(MskTxtTC.Text));
                ...
                // Cinsiyeti Combobox'tan alıyoruz
